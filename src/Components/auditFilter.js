    ...
    <div className="Transaction">
      ...
      <div className="SearchDiv">
        <TextField
          ...
          error={errors.flowId}
          helperText={errors.flowId ? 'Invalid Scenario Id' : ''}
        />
        <TextField
          label="Flow Name"
          variant="outlined"
          ...
          helperText={errors.flowName ? 'Invalid Scenario Name' : ''}
        />
        <TextField
          label="Region"
          variant="outlined"
          ...
          onChange={handleInputChange}
          error={errors.region}
          helperText={errors.region ? 'Invalid Country Code (2 characters required)' : ''}
        />
